...
//		    				}
	    		...
	    		{
		    		if(args[2].equalsIgnoreCase("buy") || args[2].equalsIgnoreCase("b"))
		    		{
		    			if(args[3].equalsIgnoreCase("chopshop") || args[3].equalsIgnoreCase("c"))
			    		{
		    				...
		    				try {
		    					...
		    					//event.getChannel().sendMessage("Parameter is not a valid integer!").queue();
		    				}
		    			...
		    			if(args[3].equalsIgnoreCase("junkyard") || args[2].equalsIgnoreCase("j"))
			    		{
		    			...
		    			if(args[3].equalsIgnoreCase("dealership") || args[2].equalsIgnoreCase("d"))
			    		{
		    				Shop shop = dbh.getShop(1);
		    				if(args[4] != null)
		    				{
		    			...
		    			if(args[3].equalsIgnoreCase("importer") || args[2].equalsIgnoreCase("i"))
			    		{
		    				Shop shop = dbh.getShop(1);
		    				if(args[4] != null)
		    				{
		    		...
		    		if(args[2].equalsIgnoreCase("chopshop") || args[2].equalsIgnoreCase("c"))
		    		{
			    		...
			    		for(int i=0; i<components.size();i++)
			    		{
			    			...
			    			Field field = new Field(components.get(i).getName(),markupText("```","ID: "+i +"\n"+ components.get(i).toString()), true);
	    					eb.addField(field);
			...
			event.getChannel().sendMessage("Unexpected error when performing that command, try again!");
	 ...
	 public String markupText(String markup, String text)
	 {
